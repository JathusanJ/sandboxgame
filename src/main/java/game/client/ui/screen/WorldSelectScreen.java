...
public class WorldSelectScreen extends Screen {
    ...
    public ButtonWidget loadWorldButton = new ButtonWidget(Language.translate("ui.screen.world_select.load_world"), () -> {
    ...
    public void renderContents(double deltaTime, int mouseX, int mouseY) {
        this.uiRenderer.renderTextWithShadow(Language.translate("ui.screen.world_select"), new Vector2f(50, this.getScreenHeight() - 32 - 50), 32);
