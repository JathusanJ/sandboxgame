...
public class RawIronChunkBlock extends StoneBlock {
    @Override
    public Vector2f[] getTextures() {
        return new Vector2f[]{
                new Vector2f(6, 4), // TOP
                new Vector2f(6, 4), // BOTTOM
                new Vector2f(6, 4), // RIGHT
                new Vector2f(6, 4), // LEFT
                new Vector2f(6, 4), // FRONT
                new Vector2f(6, 4) // BACK
        };
    }
